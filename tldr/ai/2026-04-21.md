...
[### Your AI agents are already operating outside scope (Sponsor)](https://zenity.io/resources/white-papers/enterprise-ai-security-starts-with-ai-agents?utm_source=tldr&amp;utm_medium=sponsored&amp;utm_campaign=CSA-Report&amp;utm_content=0421-ai-primary)

New Cloud Security Alliance (CSA) research makes it clear: 47% of organizations have already experienced a security incident involving an AI agent. 53% report agents regularly exceeding intended permissions. And 87% of enterprises run two or more AI agent platforms. Every additional platform is another place where policy enforcement breaks down. While only 21% maintain a real-time inventory of what's actually deployed.

AI agent adoption has outpaced visibility, ownership, and control. The [Enterprise AI Security Starts With AI Agents](https://zenity.io/resources/white-papers/enterprise-ai-security-starts-with-ai-agents?utm_source=tldr&utm_medium=sponsored&utm_campaign=CSA-Report&utm_content=0421-ai-primary) report from Cloud Security Alliance and Zenity maps the real threat landscape and what a proactive security strategy actually requires.

[→ Download the free report](https://zenity.io/resources/white-papers/enterprise-ai-security-starts-with-ai-agents?utm_source=tldr&utm_medium=sponsored&utm_campaign=CSA-Report&utm_content=0421-ai-primary)

[→ See the key findings](https://zenity.io/resources/white-papers/enterprise-ai-security-starts-with-ai-agents?utm_source=tldr&utm_medium=sponsored&utm_campaign=CSA-Report&utm_content=0421-ai-primary)

[→ Explore Zenity Labs latest AI security research](https://labs.zenity.io/?utm_source=tldr&utm_medium=sponsored&utm_campaign=Zenity-Labs&utm_content=0421-ai-primary)
...
[### Multi-agent systems that survive production (Sponsor)](https://pages.awscloud.com/awsmp-gro-hjua-webinar-mss-module-4-multi-agent-architectures-ai-series.html?trk=cac541b5-48a5-40fe-b9f3-5ced632e84d2&amp;sc_channel=el&amp;utm_source=tldrai)

AI systems fail when agents can't share state or recover from failures. Build multi-agent architectures with LangGraph for orchestration and AWS for durable messaging. [Join the AWS technical workshop + read the guide.](https://pages.awscloud.com/awsmp-gro-hjua-webinar-mss-module-4-multi-agent-architectures-ai-series.html?trk=cac541b5-48a5-40fe-b9f3-5ced632e84d2&sc_channel=el)
