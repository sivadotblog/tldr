OpenAI Mixpanel Breach 📈, Shai-Hulud Postmortem 🐛, Fake LinkedIn Jobs Malware 🧑‍💻
...
[### OpenAI API User Data Exposed in Mixpanel Breach, ChatGPT Unaffected (2 minute read)](https://hackread.com/openai-api-mixpanel-data-breach-chatgpt/?utm_source=tldrinfosec)
...
[### Asahi says crooks stole data of approximately 2M customers and employees (2 minute read)](https://securityaffairs.com/185126/data-breach/asahi-says-crooks-stole-data-of-approximately-2m-customers-and-employees.html?utm_source=tldrinfosec)
...
[### Gainsight CEO downplays impact of attack that spread to Salesforce environments (4 minute read)](https://cyberscoop.com/gainsight-ceo-downplays-salesforce-attack/?utm_source=tldrinfosec)
...
[### Threat Hunting vs. Threat Intelligence (7 minute read)](https://www.recordedfuture.com/blog/threat-hunting-vs-threat-intelligence?utm_source=tldrinfosec)
...
[### The minefield between syntaxes: exploiting syntax confusions in the wild (12 minute read)](https://www.yeswehack.com/learn-bug-bounty/syntax-confusion-ambiguous-parsing-exploits?utm_source=tldrinfosec)
...
[### XBOW: Expert-Level pentesting done in hours. No meetings required. (Sponsor)](https://xbow.com/?utm_source=tldr&amp;utm_medium=email&amp;utm_campaign=lightspeed-promo-1)

Traditional pentests take weeks or more. With [XBOW Lightspeed Pentest On-Demand](https://xbow.com/?utm_source=tldr&utm_medium=email&utm_campaign=lightspeed-promo-1) you can launch a test in minutes. Get your compliance report in 5 business days, including proof-of-exploit findings, and stay audit-ready. Try it yourself to see why XBOW is ranked #1 on the HackerOne World Leaderboard with 1,092+ zero-day vulnerabilities discovered to date. [Start your test.](https://xbow.com/pentest?utm_source=tldr&utm_medium=email&utm_campaign=lightspeed-promo-1)

[### DevOps Pipeline Attack Surface (WebApp)](https://arcanum-sec.github.io/devops-attack-surface/?utm_source=tldrinfosec)

A fully searchable, client-side guide to 88+ tools across 15 categories for pentesters and red teamers.

[### GoDefender (Github Repo)](https://github.com/EvilBytecode/GoDefender?utm_source=tldrinfosec)
...
[### Infiiscal (GitHub Repo)](https://github.com/Infisical/infisical?utm_source=tldrinfosec)
...
[### Inside the GitHub Infrastructure Powering North Korea's Contagious Interview npm Attacks (21 minute read)](https://socket.dev/blog/north-korea-contagious-interview-npm-attacks?utm_source=tldrinfosec)
...
[### Scottish council still rebuilding systems two years after ransomware attack (3 minute read)](https://www.theregister.com/2025/11/27/western_isles_ransomware_council/?utm_source=tldrinfosec)

A 2023 ransomware attack on Comhairle nan Eilean Siar forced the Western Isles council to rebuild multiple core systems, leaving some finance and revenue platforms still not fully restored two years later. The incident has cost around £950,000, created large data gaps and backlogs, and left staff under intense, prolonged pressure.

[### Report Names Teen in Scattered LAPSUS$ Hunters, Group Denies (11 minute read)](https://hackread.com/report-names-teen-scattered-lapsus-hunters-group/?utm_source=tldrinfosec)
...
[### Microsoft to secure Entra ID sign-ins from script injection attacks (3 minute read)](https://www.bleepingcomputer.com/news/microsoft/microsoft-to-secure-entra-id-sign-ins-from-external-script-injection-attacks/?utm_source=tldrinfosec)
...
[### Fake LinkedIn jobs trick Mac users into downloading Flexible Ferret malware (2 minute read)](https://www.malwarebytes.com/blog/news/2025/11/fake-linkedin-jobs-trick-mac-users-into-downloading-flexible-ferret-malware?utm_source=tldrinfosec)
...
[### Microsoft Teams' guest chat feature exposes cross-tenant blind spot (3 minute read)](https://www.csoonline.com/article/4097381/microsoft-teams-guest-chat-feature-exposes-cross-tenant-blind-spot.html?utm_source=tldrinfosec)
